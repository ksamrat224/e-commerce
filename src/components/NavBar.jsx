...
const NavBar = () => {
  return (
    <>
      <header className="text-gray-600 body-font border-2 border-b-rose-50 shadow-xl rounded-lg p-6 transition-all duration-300 hover:shadow-2xl hover:border-b-rose-500">
